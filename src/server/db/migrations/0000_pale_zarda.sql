...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "proyects" ADD CONSTRAINT "proyects_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
